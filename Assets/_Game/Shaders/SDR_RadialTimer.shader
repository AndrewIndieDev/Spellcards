...
Shader "Spell Cards/Timer"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Timer("Timer", Range( 0 , 1)) = 0
		[NoScaleOffset]_Mask("Mask", 2D) = "white" {}
		_Tint("Tint", Color) = (1,1,1,1)
		[ASEEnd]_Background("Background", Color) = (0.3773585,0.3773585,0.3773585,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_Mask25 = IN.ase_texcoord3.xy;
				float4 tex2DNode25 = tex2D( _Mask, uv_Mask25 );
				float2 texCoord22 = IN.ase_texcoord3.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_17_0 = ( texCoord22 - float2( 1,1 ) );
				float temp_output_3_0_g2 = ( _Timer - frac( ( atan2( (temp_output_17_0).x , (temp_output_17_0).y ) / TWO_PI ) ) );
				float4 lerpResult29 = lerp( _Background , _Tint , ( tex2DNode25.r * saturate( ( temp_output_3_0_g2 / fwidth( temp_output_3_0_g2 ) ) ) ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult29.rgb;
				float Alpha = tex2DNode25.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Mask25 = IN.ase_texcoord2.xy;
				float4 tex2DNode25 = tex2D( _Mask, uv_Mask25 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Mask25 = IN.ase_texcoord.xy;
				float4 tex2DNode25 = tex2D( _Mask, uv_Mask25 );
				

				surfaceDescription.Alpha = tex2DNode25.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Mask25 = IN.ase_texcoord1.xy;
				float4 tex2DNode25 = tex2D( _Mask, uv_Mask25 );
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;13;-1195.81,86.43093;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;12;-1011.981,164.2748;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TauNode;14;-1508.03,174.3697;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.ATan2OpNode;15;-1512.842,59.85324;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;17;-1966.888,140.6232;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;18;-1757.381,140.8747;Inherit;False;False;True;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;20;-1757.381,60.87472;Inherit;False;True;False;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-2209.882,120.5747;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;23;-2369.882,136.5747;Float;False;Constant;_Vector3;Vector 1;0;0;Create;True;0;0;0;False;0;False;2,2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;16;-2150.374,231.9428;Float;False;Constant;_Vector2;Vector 0;0;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;24;-515.2489,111.7994;Inherit;True;Step Antialiasing;-1;;2;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1002,-111.5;Inherit;False;Property;_Timer;Timer;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-268.2489,-53.20056;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;25;-705.2489,-302.2006;Inherit;True;Property;_Mask;Mask;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;af28470bd0e2e9543a6dfa9a1a4b348d;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;440,-89;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Spell Cards/Timer;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638257140645554944;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638257140674469071;  Use Shadow Threshold;0;0;Receive Shadows;0;638257140690970158;GPU Instancing;0;638257140698093165;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.ColorNode;27;-164.2489,-900.2006;Inherit;False;Property;_Tint;Tint;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;29;22.7511,-406.2006;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;28;-228.2489,-617.2006;Inherit;False;Property;_Background;Background;3;0;Create;True;0;0;0;False;0;False;0.3773585,0.3773585,0.3773585,0;0.3773585,0.3773585,0.3773585,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;1;3;25;1
WireConnection;29;0;28;0
WireConnection;29;1;27;0
WireConnection;29;2;26;0
ASEEND*/
//CHKSM=1BA5CDC0363B94D0AA65C76AD092FCB89A1A01BB