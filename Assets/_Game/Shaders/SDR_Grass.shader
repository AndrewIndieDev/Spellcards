	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float dotResult4_g2 = dot( objToWorld29.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2 = lerp( 0.0 , 2.0 , frac( ( sin( dotResult4_g2 ) * 43758.55 ) ));
				float clampResult42_g1 = clamp( 0.0 , 0.0001 , ( totalFrames39_g1 - 1.0 ) );
				float temp_output_35_0_g1 = frac( ( ( lerpResult10_g2 + clampResult42_g1 ) / totalFrames39_g1 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_35_0_g1 = frac( ( ( lerpResult10_g2 + clampResult42_g1 ) / totalFrames39_g1 ) );
				float2 appendResult29_g1 = (float2(temp_output_35_0_g1 , ( 1.0 - temp_output_35_0_g1 )));
				float2 temp_output_15_0_g1 = ( ( IN.ase_texcoord.xy / appendResult7_g1 ) + ( floor( ( appendResult8_g1 * appendResult29_g1 ) ) / appendResult7_g1 ) );
				float4 tex2DNode26 = tex2D( _Mask, temp_output_15_0_g1 );
				

				surfaceDescription.Alpha = tex2DNode26.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_35_0_g1 = frac( ( ( lerpResult10_g2 + clampResult42_g1 ) / totalFrames39_g1 ) );
				float2 appendResult29_g1 = (float2(temp_output_35_0_g1 , ( 1.0 - temp_output_35_0_g1 )));
				float2 temp_output_15_0_g1 = ( ( IN.ase_texcoord1.xy / appendResult7_g1 ) + ( floor( ( appendResult8_g1 * appendResult29_g1 ) ) / appendResult7_g1 ) );
				float4 tex2DNode26 = tex2D( _Mask, temp_output_15_0_g1 );
